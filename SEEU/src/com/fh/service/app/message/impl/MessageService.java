package com.fh.service.app.message.impl;
...
public class MessageService implements MessageManager{
	...
	@Override
	public List<PageData> myMsglistAll(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("MessageMapper.myMsglistAll", pd);
	}

	@Override
	public void editMsgState(PageData pd) throws Exception {
		dao.update("MessageMapper.editMsgState", pd);
	}
