package com.fh.service.app.banner.impl;
...
public class BannerService implements BannerManager{
	...
	@Override
	public List<PageData> banners(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("BannerMapper.banners", pd);
	}
