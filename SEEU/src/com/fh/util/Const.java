...
*/
public class Const {
	public static final String WEB_SERVICE_URL = "http://192.168.0.16:8080/fakie/";//项目访问地址
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(app)|(code)|(weixin)|(static)|(main)|(websocket)).*";	//不对匹配该值的访问路径拦截（正则）
