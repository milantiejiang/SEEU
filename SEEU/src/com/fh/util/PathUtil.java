...
public class PathUtil {
	 ...
	 * @return
	 */
	public static String getClasspath3(){
		String path =  (String.valueOf(Thread.currentThread().getContextClassLoader().getResource(""))).replaceAll("WEB-INF/classes/", "").replaceAll("file:/", "").replaceAll("%20", " ").trim();	
		if(path.indexOf(":") != 1){
			path = File.separator + path;
		}
		return path;
