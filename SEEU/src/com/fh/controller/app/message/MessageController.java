...
public class MessageController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("app/message/message_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("app/message/message_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("COMMENT"));	    //1
			vpd.put("var2", varOList.get(i).getString("COLLECTION"));	    //2
			vpd.put("var3", varOList.get(i).getString("FABULOUS"));	    //3
			vpd.put("var4", varOList.get(i).getString("TIME"));	    //4
			vpd.put("var5", varOList.get(i).get("ISREAD").toString());	//5
